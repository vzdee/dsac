    ...
    <div>
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="lg:col-span-2 rounded-xl border border-gray-200 bg-gray-100 p-3">
                ...
                <div class="flex flex-col gap-3 border border-gray-200 bg-white p-5 shadow-sm rounded-lg">
                    ...
                    <x-ts-select.styled label="Género *" name="gender" placeholder="Elige un opción" :options="[['value' => 'male', 'label' => 'Masculino'], ['value' => 'female', 'label' => 'Femenino']]" :value="old('gender')" required />
                </div>
                <div class="flex flex-col gap-3 border border-gray-200 bg-white p-5 shadow-sm rounded-lg">
                    <div>
                ...
                <div class="flex flex-col gap-3 border border-gray-200 bg-white p-5 shadow-sm rounded-lg">
                    ...
                    <x-ts-select.styled label="Role *" name="role_id" :value="old('role_id')" placeholder="Elige un rol para el usuario" hint="" :options="$roles" required  />
                </div>
            </div>
            <div class="mt-6">
